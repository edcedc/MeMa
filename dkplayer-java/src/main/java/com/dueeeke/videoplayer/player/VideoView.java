...
public class VideoView extends FrameLayout implements MediaPlayerControl, PlayerEventListener {
    ...
    protected void initView() {
        ...
        centerImageView = new ImageView(getContext());
        LayoutParams paramsImage = new LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        paramsImage.gravity = Gravity.CENTER;
        centerImageView.setBackgroundResource(R.drawable.playing);
        centerImageView.setVisibility(GONE);
        this.addView(centerImageView, paramsImage);
...
//        if (checkNetwork()) return;
     ...
     *  设置播放图标
     */
    public void setPlayImg(int visibility){
        centerImageView.setVisibility(visibility);
    }
