 ...
 * Time: 16:32
 */
public class SetAddressPresenter extends SetAddressContract.Presenter{
    @Override
    ...
    public void onDel(String id, int position) {
        CloudApi.userDelUserAddress(id)
                .doOnSubscribe(disposable -> {})
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<Response<BaseResponseBean>>() {
                    @Override
    ...
    @Override
    public void onEdit(String id, int position) {
