...
public class CalendarView extends RelativeLayout implements OnDaySelectedListener,
    ...
    private void handleAttributes(TypedArray typedArray) {
        ...
        int monthTextColor = typedArray.getColor(R.styleable.CalendarView_monthTextColor, ContextCompat.getColor(getContext(), R.color.default_calendar_background_color));
        ...
        int weekendDayTextColor = typedArray.getColor(R.styleable.CalendarView_weekendDayTextColor, ContextCompat.getColor(getContext(), R.color.default_calendar_background_color));
        int weekDayTitleTextColor = typedArray.getColor(R.styleable.CalendarView_weekDayTitleTextColor, ContextCompat.getColor(getContext(), R.color.default_calendar_background_color));
        int selectedDayTextColor = typedArray.getColor(R.styleable.CalendarView_selectedDayTextColor, ContextCompat.getColor(getContext(), R.color.red_EE3257));
        int selectedDayBackgroundColor = typedArray.getColor(R.styleable.CalendarView_selectedDayBackgroundColor, ContextCompat.getColor(getContext(), R.color.default_selected_day_text_color));
...
//        setBackgroundResource(R.drawable.icon_y1);
...
//        flBottomSelectionBar.setLayoutTransition(new LayoutTransition());
    ...
    private void createMultipleSelectionBarRecycler() {
        ...
        rvMultipleSelectedList.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
...
//                ivNext.setVisibility(show ? View.VISIBLE : View.GONE);
    ...
    public void onDaySelected() {
        ...
        for (int i = 0;i < selectedDays.size();i++){
            Calendar calendar = selectedDays.get(i).getCalendar();
            long timeInMillis = calendar.getTimeInMillis();
            if (onMonthChangeListener != null){
                onMonthChangeListener.onSelectChanged(timeInMillis);
            }
        }
    }
